...
public class QAReportServiceImpl implements QAReportService {
    ...
    private QAReportDetailDTO mapToDetailDTO(QAReport report) {
        return QAReportDetailDTO.builder()
                ...
                .branchId(report.getClassEntity().getBranch() != null ? report.getClassEntity().getBranch().getId() : null)
                .branchName(report.getClassEntity().getBranch() != null ? report.getClassEntity().getBranch().getName() : null)
