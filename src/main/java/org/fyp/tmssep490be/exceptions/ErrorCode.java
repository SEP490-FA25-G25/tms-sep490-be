...
public enum ErrorCode {
    ...
    INSUFFICIENT_RESOURCE_CAPACITY(2206, "Resource capacity is insufficient for class size"),
    ...
    CLASS_INVALID_STATUS(1208, "Class must be in 'scheduled' or 'ongoing' status for enrollment"),
    ...
    CLASS_NOT_SCHEDULED(4003, "Class must be in scheduled or ongoing status to be accessible"),
