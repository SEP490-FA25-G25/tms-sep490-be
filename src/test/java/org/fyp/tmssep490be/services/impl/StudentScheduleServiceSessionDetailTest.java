 ...
 * Tests the critical bug fix where course materials should be returned instead
 * of room names.
 */
@SpringBootTest
@ActiveProfiles("test")
...
class StudentScheduleServiceSessionDetailTest {
        ...
        private void setupTestData() {
                ...
                // 5. Create Course Materials (the actual learning materials, NOT room
                // resources)
        ...
        void shouldGetSessionDetailWithMaterialsAndResources() {
                ...
                // Verify materials contain expected learning materials (order not guaranteed
                // due to Set)
                ...
                assertThat(result.getMaterials())
                                .noneMatch(material -> material.getFileName().equals("Ha Noi Room 101") ||
        ...
        void shouldHandleVirtualResourcesWithZoomLinks() {
                ...
                assertThat(result.getClassroomResource().getResourceName())
                                .isEqualTo("https://zoom.us/j/123456789?pwd=abc123");
                ...
                assertThat(result.getClassroomResource().getOnlineLink())
                                .isEqualTo("https://zoom.us/j/123456789?pwd=abc123");
        ...
        void shouldUseFirstResourceWhenMultipleAssigned() {
                ...
                testSession.setSessionResources(
                                new HashSet<>(Arrays.asList(roomSessionResource, virtualSessionResource)));
                ...
                assertThat(result.getClassroomResource().getResourceType()).isIn(ResourceType.ROOM,
